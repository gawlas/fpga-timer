...
set property PULLUP true [get_ports { AN[4] }];
set property PULLUP true [get_ports { AN[5] }];
set property PULLUP true [get_ports { AN[6] }];
set property PULLUP true [get_ports { AN[7] }];
